...
public class Subject implements UserProfile {
  ...
  private final transient Logger logger = ESAPI.getLogger("User");
   ...
   *
   * @param accountName The name of this user's account.
   */
  ...
  public void setAccountName(String accountName) {
    ...
    if (old != null) {
      ...
      logger.info(Logger.SECURITY_SUCCESS, "Account name changed from " + old + " to "
          + getAccountName());
    }
  }
  ...
  public void setExpirationDate(Date expirationDate) {
    ...
    logger.info(Logger.SECURITY_SUCCESS, "Account expiration date set to " + expirationDate
        + " for " + getAccountName());
  }
  ...
  public void setScreenName(String screenName) {
    ...
    logger.info(Logger.SECURITY_SUCCESS, "ScreenName changed to " + screenName + " for "
        + getAccountName());
  }
  ...
  public void setLastFailedLoginTime(Date lastFailedLoginTime) {
    ...
    logger.info(Logger.SECURITY_SUCCESS, "Set last failed login time to " + lastFailedLoginTime
        + " for " + getAccountName());
  }
  ...
  public void setLastHostAddress(String remoteHost) {
    if (lastHostAddress != null && !lastHostAddress.equals(remoteHost)) {
      ...
      // throw new AuthenticationHostException("Host change", "User session just jumped from " +
      // lastHostAddress + " to " + remoteHost );
    }
  ...
  public void setLastLoginTime(Date lastLoginTime) {
    ...
    logger.info(Logger.SECURITY_SUCCESS, "Set last successful login time to " + lastLoginTime
        + " for " + getAccountName());
  }
  ...
  public void setLastPasswordChangeTime(Date lastPasswordChangeTime) {
    ...
    logger.info(Logger.SECURITY_SUCCESS, "Set last password change time to "
        + lastPasswordChangeTime + " for " + getAccountName());
  }
