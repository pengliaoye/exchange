 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws.exchange.dm.com/", wsdlLocation = "file:/C:/tmp/HelloService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://ws.exchange.dm.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/tmp/HelloService.wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://ws.exchange.dm.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.exchange.dm.com/", "HelloPort"), Hello.class, features);
    }
